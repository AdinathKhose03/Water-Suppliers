...
```
cd existing_repo
git remote add origin https://gitlab.com/saurabhwagh124/python-super-x.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/saurabhwagh124/python-super-x/-/settings/integrations)
